...
const monitor_worker_1 = require("./monitor.worker");
...
exports.MonitorsModule = MonitorsModule = __decorate([
    (0, common_1.Module)({
        controllers: [monitors_controller_1.MonitorsController],
        providers: [monitors_service_1.MonitorsService, monitor_worker_1.MonitorWorker, prisma_service_1.PrismaService],
    })
], MonitorsModule);
